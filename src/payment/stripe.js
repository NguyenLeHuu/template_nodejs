...
const STRIPE_SETTINGS = {
  ...
  stripe_success_url: 'http://localhost:8080/user/vi',
  stripe_cancel_url: 'http://localhost:8080/user/checkout/canceled.html',
...
stripeApp.post("/charge", async (req, res) => {
...
stripeApp.post("/webhook", async (request, response) => {
...
stripeApp.get("/subscribe/:project", async (request, response) => {
